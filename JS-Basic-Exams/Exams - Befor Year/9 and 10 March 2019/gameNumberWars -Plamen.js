function numWars(input){
    ...
    while(command != 'End of game'){
        ...
        if(firsPlayerCard > secondPlayerCard){                      
            ...
            if(firsPlayerCard > secondPlayerCard){
                // let points = firsPlayerCard - secondPlayerCard;  //in case of NumWars the winner of the War doesn not
                // firstPlayerPoints += points                      //get the points from the NumWars so we print the points
                                                                    //he has up until the point of the NumWar.
...
//(['Alex','Georgi','4','5','3','2','4','3','4','4','5','2'])
numWars(["Elena",
"Simeon",
"5",
"3",
